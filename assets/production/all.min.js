...
assembled:!0}))},height:function(e){var n=0,i=this;return t("> li",e).each(function(){n+=i.S(this).outerHeight(!0)}),n},sticky:function(){var t=this;this.S(e).on("scroll",function(){t.update_sticky_positioning()})},update_sticky_positioning:function(){var t="."+this.settings.sticky_class,n=this.S(e),i=this;if(i.settings.sticky_topbar&&i.is_sticky(this.settings.sticky_topbar,this.settings.sticky_topbar.parent(),this.settings)){var s=this.settings.sticky_topbar.data("stickyoffset")+this.settings.start_offset;i.S(t).hasClass("expanded")||(n.scrollTop()>s?i.S(t).hasClass("fixed")||(i.S(t).addClass("fixed"),i.S("body").addClass("f-topbar-fixed")):n.scrollTop()<=s&&i.S(t).hasClass("fixed")&&(i.S(t).removeClass("fixed"),i.S("body").removeClass("f-topbar-fixed")))}},off:function(){this.S(this.scope).off(".fndtn.topbar"),this.S(e).off(".fndtn.topbar")},reflow:function(){}}}(jQuery,window,window.document),function(t,e,n,i){"use strict";Foundation.libs.topbar={name:"topbar",version:"5.5.3",settings:{index:0,start_offset:0,sticky_class:"sticky",custom_back_text:!0,back_text:"Back",mobile_show_parent_link:!0,is_hover:!0,scrolltop:!0,sticky_on:"all",dropdown_autoclose:!0},init:function(e,n,i){Foundation.inherit(this,"add_custom_rule register_media throttle");var s=this;s.register_media("topbar","foundation-mq-topbar"),this.bindings(n,i),s.S("["+this.attr_name()+"]",this.scope).each(function(){var e=t(this),n=e.data(s.attr_name(!0)+"-init");s.S("section, .top-bar-section",this);e.data("index",0);var i=e.parent();i.hasClass("fixed")||s.is_sticky(e,i,n)?(s.settings.sticky_class=n.sticky_class,s.settings.sticky_topbar=e,e.data("height",i.outerHeight()),e.data("stickyoffset",i.offset().top)):e.data("height",e.outerHeight()),n.assembled||s.assemble(e),n.is_hover?s.S(".has-dropdown",e).addClass("not-click"):s.S(".has-dropdown",e).removeClass("not-click"),s.add_custom_rule(".f-topbar-fixed { padding-top: "+e.data("height")+"px }"),i.hasClass("fixed")&&s.S("body").addClass("f-topbar-fixed")})},is_sticky:function(t,e,n){var i=e.hasClass(n.sticky_class),s=matchMedia(Foundation.media_queries.small).matches,a=matchMedia(Foundation.media_queries.medium).matches,o=matchMedia(Foundation.media_queries.large).matches;return!(!i||"all"!==n.sticky_on)||(!(!(i&&this.small()&&n.sticky_on.indexOf("small")!==-1&&s)||a||o)||(!(!(i&&this.medium()&&n.sticky_on.indexOf("medium")!==-1&&s&&a)||o)||!!(i&&this.large()&&n.sticky_on.indexOf("large")!==-1&&s&&a&&o)))},toggle:function(n){var i,s=this;i=n?s.S(n).closest("["+this.attr_name()+"]"):s.S("["+this.attr_name()+"]");var a=i.data(this.attr_name(!0)+"-init"),o=s.S("section, .top-bar-section",i);s.breakpoint()&&(s.rtl?(o.css({right:"0%"}),t(">.name",o).css({right:"100%"})):(o.css({left:"0%"}),t(">.name",o).css({left:"100%"})),s.S("li.moved",o).removeClass("moved"),i.data("index",0),i.toggleClass("expanded").css("height","")),a.scrolltop?i.hasClass("expanded")?i.parent().hasClass("fixed")&&(a.scrolltop?(i.parent().removeClass("fixed"),i.addClass("fixed"),s.S("body").removeClass("f-topbar-fixed"),e.scrollTo(0,0)):i.parent().removeClass("expanded")):i.hasClass("fixed")&&(i.parent().addClass("fixed"),i.removeClass("fixed"),s.S("body").addClass("f-topbar-fixed")):(s.is_sticky(i,i.parent(),a)&&i.parent().addClass("fixed"),i.parent().hasClass("fixed")&&(i.hasClass("expanded")?(i.addClass("fixed"),i.parent().addClass("expanded"),s.S("body").addClass("f-topbar-fixed")):(i.removeClass("fixed"),i.parent().removeClass("expanded"),s.update_sticky_positioning())))},timer:null,events:function(n){var i=this,s=this.S;s(this.scope).off(".topbar").on("click.fndtn.topbar","["+this.attr_name()+"] .toggle-topbar",function(t){t.preventDefault(),i.toggle(this)}).on("click.fndtn.topbar contextmenu.fndtn.topbar",'.top-bar .top-bar-section li a[href^="#"],['+this.attr_name()+'] .top-bar-section li a[href^="#"]',function(e){var n=t(this).closest("li"),s=n.closest("["+i.attr_name()+"]"),a=s.data(i.attr_name(!0)+"-init");if(a.dropdown_autoclose&&a.is_hover){var o=t(this).closest(".hover");o.removeClass("hover")}!i.breakpoint()||n.hasClass("back")||n.hasClass("has-dropdown")||i.toggle()}).on("click.fndtn.topbar","["+this.attr_name()+"] li.has-dropdown",function(e){var n=s(this),a=s(e.target),o=n.closest("["+i.attr_name()+"]"),r=o.data(i.attr_name(!0)+"-init");return a.data("revealId")?void i.toggle():void(i.breakpoint()||r.is_hover&&!Modernizr.touch||(e.stopImmediatePropagation(),n.hasClass("hover")?(n.removeClass("hover").find("li").removeClass("hover"),n.parents("li.hover").removeClass("hover")):(n.addClass("hover"),t(n).siblings().removeClass("hover"),"A"===a[0].nodeName&&a.parent().hasClass("has-dropdown")&&e.preventDefault())))}).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown>a",function(t){if(i.breakpoint()){t.preventDefault();var e=s(this),n=e.closest("["+i.attr_name()+"]"),a=n.find("section, .top-bar-section"),o=(e.next(".dropdown").outerHeight(),e.closest("li"));n.data("index",n.data("index")+1),o.addClass("moved"),i.rtl?(a.css({right:-(100*n.data("index"))+"%"}),a.find(">.name").css({right:100*n.data("index")+"%"})):(a.css({left:-(100*n.data("index"))+"%"}),a.find(">.name").css({left:100*n.data("index")+"%"})),n.css("height",e.siblings("ul").outerHeight(!0)+n.data("height"))}}),s(e).off(".topbar").on("resize.fndtn.topbar",i.throttle(function(){i.resize.call(i)},50)).trigger("resize.fndtn.topbar").load(function(){s(this).trigger("resize.fndtn.topbar")}),s("body").off(".topbar").on("click.fndtn.topbar",function(t){var e=s(t.target).closest("li").closest("li.hover");e.length>0||s("["+i.attr_name()+"] li.hover").removeClass("hover")}),s(this.scope).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown .back",function(t){t.preventDefault();var e=s(this),n=e.closest("["+i.attr_name()+"]"),a=n.find("section, .top-bar-section"),o=(n.data(i.attr_name(!0)+"-init"),e.closest("li.moved")),r=o.parent();n.data("index",n.data("index")-1),i.rtl?(a.css({right:-(100*n.data("index"))+"%"}),a.find(">.name").css({right:100*n.data("index")+"%"})):(a.css({left:-(100*n.data("index"))+"%"}),a.find(">.name").css({left:100*n.data("index")+"%"})),0===n.data("index")?n.css("height",""):n.css("height",r.outerHeight(!0)+n.data("height")),setTimeout(function(){o.removeClass("moved")},300)}),s(this.scope).find(".dropdown a").focus(function(){t(this).parents(".has-dropdown").addClass("hover")}).blur(function(){t(this).parents(".has-dropdown").removeClass("hover")})},resize:function(){var t=this;t.S("["+this.attr_name()+"]").each(function(){var e,i=t.S(this),s=i.data(t.attr_name(!0)+"-init"),a=i.parent("."+t.settings.sticky_class);if(!t.breakpoint()){var o=i.hasClass("expanded");i.css("height","").removeClass("expanded").find("li").removeClass("hover"),o&&t.toggle(i)}t.is_sticky(i,a,s)&&(a.hasClass("fixed")?(a.removeClass("fixed"),e=a.offset().top,t.S(n.body).hasClass("f-topbar-fixed")&&(e-=i.data("height")),i.data("stickyoffset",e),a.addClass("fixed")):(e=a.offset().top,i.data("stickyoffset",e)))})},breakpoint:function(){return!matchMedia(Foundation.media_queries.topbar).matches},small:function(){return matchMedia(Foundation.media_queries.small).matches},medium:function(){return matchMedia(Foundation.media_queries.medium).matches},large:function(){return matchMedia(Foundation.media_queries.large).matches},assemble:function(e){var n=this,i=e.data(this.attr_name(!0)+"-init"),s=n.S("section, .top-bar-section",e);s.detach(),n.S(".has-dropdown>a",s).each(function(){var e,s=n.S(this),a=s.siblings(".dropdown"),o=s.attr("href");a.find(".title.back").length||(e=t(1==i.mobile_show_parent_link&&o?'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li><li class="parent-link hide-for-medium-up"><a class="parent-link js-generated" href="'+o+'">'+s.html()+"</a></li>":'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5>'),1==i.custom_back_text?t("h5>a",e).html(i.back_text):t("h5>a",e).html("&laquo; "+s.html()),a.prepend(e))}),s.appendTo(e),this.sticky(),this.assembled(e)},assembled:function(e){e.data(this.attr_name(!0),t.extend({},e.data(this.attr_name(!0)),{assembled:!0}))},height:function(e){var n=0,i=this;return t("> li",e).each(function(){n+=i.S(this).outerHeight(!0)}),n},sticky:function(){var t=this;this.S(e).on("scroll",function(){t.update_sticky_positioning()})},update_sticky_positioning:function(){var t="."+this.settings.sticky_class,n=this.S(e),i=this;if(i.settings.sticky_topbar&&i.is_sticky(this.settings.sticky_topbar,this.settings.sticky_topbar.parent(),this.settings)){var s=this.settings.sticky_topbar.data("stickyoffset")+this.settings.start_offset;i.S(t).hasClass("expanded")||(n.scrollTop()>s?i.S(t).hasClass("fixed")||(i.S(t).addClass("fixed"),i.S("body").addClass("f-topbar-fixed")):n.scrollTop()<=s&&i.S(t).hasClass("fixed")&&(i.S(t).removeClass("fixed"),i.S("body").removeClass("f-topbar-fixed")))}},off:function(){this.S(this.scope).off(".fndtn.topbar"),this.S(e).off(".fndtn.topbar")},reflow:function(){}}}(jQuery,window,window.document),!function(t,e){var n=e(t,t.document);t.lazySizes=n,"object"==typeof module&&module.exports&&(module.exports=n)}(window,function(t,e){"use strict";if(e.getElementsByClassName){var n,i=e.documentElement,s=t.Date,a=t.HTMLPictureElement,o="addEventListener",r="getAttribute",l=t[o],c=t.setTimeout,d=t.requestAnimationFrame||c,u=t.requestIdleCallback,h=/^picture$/i,f=["load","error","lazyincluded","_lazyloaded"],p={},g=Array.prototype.forEach,m=function(t,e){return p[e]||(p[e]=new RegExp("(\\s|^)"+e+"(\\s|$)")),p[e].test(t[r]("class")||"")&&p[e]},v=function(t,e){m(t,e)||t.setAttribute("class",(t[r]("class")||"").trim()+" "+e)},_=function(t,e){var n;(n=m(t,e))&&t.setAttribute("class",(t[r]("class")||"").replace(n," "))},y=function(t,e,n){var i=n?o:"removeEventListener";n&&y(t,e),f.forEach(function(n){t[i](n,e)})},b=function(t,n,i,s,a){var o=e.createEvent("CustomEvent");return o.initCustomEvent(n,!s,!a,i||{}),t.dispatchEvent(o),o},x=function(e,i){var s;!a&&(s=t.picturefill||n.pf)?s({reevaluate:!0,elements:[e]}):i&&i.src&&(e.src=i.src)},w=function(t,e){return(getComputedStyle(t,null)||{})[e]},C=function(t,e,i){for(i=i||t.offsetWidth;i<n.minSize&&e&&!t._lazysizesWidth;)i=e.offsetWidth,e=e.parentNode;return i},k=function(){var t,n,i=[],s=[],a=i,o=function(){var e=a;for(a=i.length?s:i,t=!0,n=!1;e.length;)e.shift()();t=!1},r=function(i,s){t&&!s?i.apply(this,arguments):(a.push(i),n||(n=!0,(e.hidden?c:d)(o)))};return r._lsFlush=o,r}(),S=function(t,e){return e?function(){k(t)}:function(){var e=this,n=arguments;k(function(){t.apply(e,n)})}},T=function(t){var e,n=0,i=125,a=666,o=a,r=function(){e=!1,n=s.now(),t()},l=u?function(){u(r,{timeout:o}),o!==a&&(o=a)}:S(function(){c(r)},!0);return function(t){var a;(t=t===!0)&&(o=44),e||(e=!0,a=i-(s.now()-n),0>a&&(a=0),t||9>a&&u?l():c(l,a))}},A=function(t){var e,n,i=99,a=function(){e=null,t()},o=function(){var t=s.now()-n;i>t?c(o,i-t):(u||a)(a)};return function(){n=s.now(),e||(e=c(o,i))}},j=function(){var a,d,u,f,p,C,j,$,q,F,E,N,z,H,M,L=/^img$/i,W=/^iframe$/i,P="onscroll"in t&&!/glebot/.test(navigator.userAgent),O=0,R=0,I=0,B=-1,X=function(t){I--,t&&t.target&&y(t.target,X),(!t||0>I||!t.target)&&(I=0)},Q=function(t,n){var s,a=t,o="hidden"==w(e.body,"visibility")||"hidden"!=w(t,"visibility");for(q-=n,N+=n,F-=n,E+=n;o&&(a=a.offsetParent)&&a!=e.body&&a!=i;)o=(w(a,"opacity")||1)>0,o&&"visible"!=w(a,"overflow")&&(s=a.getBoundingClientRect(),o=E>s.left&&F<s.right&&N>s.top-1&&q<s.bottom+1);return o},Y=function(){var t,s,o,l,c,h,f,g,m;if((p=n.loadMode)&&8>I&&(t=a.length)){s=0,B++,null==H&&("expand"in n||(n.expand=i.clientHeight>500&&i.clientWidth>500?500:370),z=n.expand,H=z*n.expFactor),H>R&&1>I&&B>2&&p>2&&!e.hidden?(R=H,B=0):R=p>1&&B>1&&6>I?z:O;for(;t>s;s++)if(a[s]&&!a[s]._lazyRace)if(P)if((g=a[s][r]("data-expand"))&&(h=1*g)||(h=R),m!==h&&(j=innerWidth+h*M,$=innerHeight+h,f=-1*h,m=h),o=a[s].getBoundingClientRect(),(N=o.bottom)>=f&&(q=o.top)<=$&&(E=o.right)>=f*M&&(F=o.left)<=j&&(N||E||F||q)&&(u&&3>I&&!g&&(3>p||4>B)||Q(a[s],h))){if(et(a[s]),c=!0,I>9)break}else!c&&u&&!l&&4>I&&4>B&&p>2&&(d[0]||n.preloadAfterLoad)&&(d[0]||!g&&(N||E||F||q||"auto"!=a[s][r](n.sizesAttr)))&&(l=d[0]||a[s]);else et(a[s]);l&&!c&&et(l)}},U=T(Y),V=function(t){v(t.target,n.loadedClass),_(t.target,n.loadingClass),y(t.target,G)},Z=S(V),G=function(t){Z({target:t.target})},J=function(t,e){try{t.contentWindow.location.replace(e)}catch(n){t.src=e}},K=function(t){var e,i,s=t[r](n.srcsetAttr);(e=n.customMedia[t[r]("data-media")||t[r]("media")])&&t.setAttribute("media",e),s&&t.setAttribute("srcset",s),e&&(i=t.parentNode,i.insertBefore(t.cloneNode(),t),i.removeChild(t))},tt=S(function(t,e,i,s,a){var o,l,d,u,p,m;(p=b(t,"lazybeforeunveil",e)).defaultPrevented||(s&&(i?v(t,n.autosizesClass):t.setAttribute("sizes",s)),l=t[r](n.srcsetAttr),o=t[r](n.srcAttr),a&&(d=t.parentNode,u=d&&h.test(d.nodeName||"")),m=e.firesLoad||"src"in t&&(l||o||u),p={target:t},m&&(y(t,X,!0),clearTimeout(f),f=c(X,2500),v(t,n.loadingClass),y(t,G,!0)),u&&g.call(d.getElementsByTagName("source"),K),l?t.setAttribute("srcset",l):o&&!u&&(W.test(t.nodeName)?J(t,o):t.src=o),(l||u)&&x(t,{src:o})),t._lazyRace&&delete t._lazyRace,_(t,n.lazyClass),k(function(){(!m||t.complete&&t.naturalWidth>1)&&(m?X(p):I--,V(p))},!0)}),et=function(t){var e,i=L.test(t.nodeName),s=i&&(t[r](n.sizesAttr)||t[r]("sizes")),a="auto"==s;(!a&&u||!i||!t.src&&!t.srcset||t.complete||m(t,n.errorClass))&&(e=b(t,"lazyunveilread").detail,a&&D.updateElem(t,!0,t.offsetWidth),t._lazyRace=!0,I++,tt(t,e,a,s,i))},nt=function(){if(!u){if(s.now()-C<999)return void c(nt,999);var t=A(function(){n.loadMode=3,U()});u=!0,n.loadMode=3,U(),l("scroll",function(){3==n.loadMode&&(n.loadMode=2),t()},!0)}};return{_:function(){C=s.now(),a=e.getElementsByClassName(n.lazyClass),d=e.getElementsByClassName(n.lazyClass+" "+n.preloadClass),M=n.hFac,l("scroll",U,!0),l("resize",U,!0),t.MutationObserver?new MutationObserver(U).observe(i,{childList:!0,subtree:!0,attributes:!0}):(i[o]("DOMNodeInserted",U,!0),i[o]("DOMAttrModified",U,!0),setInterval(U,999)),l("hashchange",U,!0),["focus","mouseover","click","load","transitionend","animationend","webkitAnimationEnd"].forEach(function(t){e[o](t,U,!0)}),/d$|^c/.test(e.readyState)?nt():(l("load",nt),e[o]("DOMContentLoaded",U),c(nt,2e4)),a.length?(Y(),k._lsFlush()):U()},checkElems:U,unveil:et}}(),D=function(){var t,i=S(function(t,e,n,i){var s,a,o;if(t._lazysizesWidth=i,i+="px",t.setAttribute("sizes",i),h.test(e.nodeName||""))for(s=e.getElementsByTagName("source"),a=0,o=s.length;o>a;a++)s[a].setAttribute("sizes",i);n.detail.dataAttr||x(t,n.detail)}),s=function(t,e,n){var s,a=t.parentNode;a&&(n=C(t,a,n),s=b(t,"lazybeforesizes",{width:n,dataAttr:!!e}),s.defaultPrevented||(n=s.detail.width,n&&n!==t._lazysizesWidth&&i(t,a,s,n)))},a=function(){var e,n=t.length;if(n)for(e=0;n>e;e++)s(t[e])},o=A(a);return{_:function(){t=e.getElementsByClassName(n.autosizesClass),l("resize",o)},checkElems:o,updateElem:s}}(),$=function(){$.i||($.i=!0,D._(),j._())};return function(){var e,i={lazyClass:"lazyload",loadedClass:"lazyloaded",loadingClass:"lazyloading",preloadClass:"lazypreload",errorClass:"lazyerror",autosizesClass:"lazyautosizes",srcAttr:"data-src",srcsetAttr:"data-srcset",sizesAttr:"data-sizes",minSize:40,customMedia:{},init:!0,expFactor:1.5,hFac:.8,loadMode:2};n=t.lazySizesConfig||t.lazysizesConfig||{};for(e in i)e in n||(n[e]=i[e]);t.lazySizesConfig=n,c(function(){n.init&&$()})}(),{cfg:n,autoSizer:D,loader:j,init:$,uP:x,aC:v,rC:_,hC:m,fire:b,gW:C,rAF:k}}}),$(document).ready(function(){$(document).foundation(),init()});