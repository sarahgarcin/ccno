...
return function ($site, $pages, $page)
{
    ...
    if (r::is('POST')) {
        $form->emailAction([
            ...
            'subject' => 'Nouvelle audition Bruxelles',
            // Use a snippet for the email body (see below).
            'snippet' => 'emails/demandeauditionsbruxelles',
        ])
        ->emailAction([
            ...
            'subject' => '[CCNO] - Confirmation auditions de Bruxelles',
            // Use a snippet for the email body (see below).
            'snippet' => 'emails/successauditionsbruxelles',
        ])
        ->uploadAction(['fields' => [
            'cv' => [
                'target' => kirby()->roots()->content().'/auditions-bruxelles',
                'prefix' => false,
            ],
            'picture' => [
                'target' => kirby()->roots()->content().'/auditions-bruxelles',
