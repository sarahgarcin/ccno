...
$data = array(
array($form->data('name'), $form->data('firstname'), $form->data('structurename'), $form->data('region'), $form->data('contact'), $form->data('adresse'), $form->data('telephone1'), $form->data('telephone2'), $form->data('email1'), $form->data('email2'), $form->data('titre'), $form->data('distribution'), $form->data('periode'), $form->data('nombrepersonne'), $form->data('calendrier'), $form->data('budget'), $form->data('aide'), $form->data('coproductions'), $form->data('liensvideos'), 'http://www.ccn-orleans.com/content/'.$form->data('presentation')['name'],  'http://www.ccn-orleans.com/content/'.$form->data('budgetpdf')['name'])
);
